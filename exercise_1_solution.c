...
#include <stdlib.h>
    ...
    void incIngredient(int *ingredient, int incValue) {
        if (*ingredient + incValue < 1000 && *ingredient + incValue <0) {
            *ingredient = abs(*ingredient + incValue);
        } else {
    ...
    void decIngredient(int *ingredient, int decValue) {
        if (*ingredient - decValue > 0 && *ingredient - decValue <1000) {
            *ingredient = abs(*ingredient - decValue);
        } else {
